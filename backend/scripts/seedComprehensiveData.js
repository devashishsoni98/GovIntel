...
const seedComprehensiveData = async () => {
  try {
    ...
    const citizenData = [
      { name: "Anita Sharma", email: "anita.sharma@email.com", phone: "+91-9876543210" },
      { name: "Rohit Gupta", email: "rohit.gupta@email.com", phone: "+91-9876543211" },
      { name: "Sneha Patel", email: "sneha.patel@email.com", phone: "+91-9876543212" },
      { name: "Vikash Singh", email: "vikash.singh@email.com", phone: "+91-9876543213" },
      { name: "Ritu Agarwal", email: "ritu.agarwal@email.com", phone: "+91-9876543214" },
      { name: "Manish Kumar", email: "manish.kumar@email.com", phone: "+91-9876543215" },
      { name: "Deepika Reddy", email: "deepika.reddy@email.com", phone: "+91-9876543216" },
      { name: "Arjun Malhotra", email: "arjun.malhotra@email.com", phone: "+91-9876543217" },
      { name: "Kavya Joshi", email: "kavya.joshi@email.com", phone: "+91-9876543218" },
      { name: "Sanjay Verma", email: "sanjay.verma@email.com", phone: "+91-9876543219" },
    ];
    ...
    const officerData = [
      { name: "Rajesh Kumar Singh", email: "rajesh.singh@municipal.gov", department: "MUNICIPAL" },
      { name: "Priya Sharma", email: "priya.sharma@municipal.gov", department: "MUNICIPAL" },
      { name: "Amit Patel", email: "amit.patel@municipal.gov", department: "MUNICIPAL" },
      { name: "Dr. Sunita Reddy", email: "sunita.reddy@health.gov", department: "HEALTH" },
      { name: "Dr. Vikram Gupta", email: "vikram.gupta@health.gov", department: "HEALTH" },
      { name: "Prof. Ramesh Agarwal", email: "ramesh.agarwal@education.gov", department: "EDUCATION" },
      { name: "Kavita Desai", email: "kavita.desai@education.gov", department: "EDUCATION" },
      { name: "Ravi Malhotra", email: "ravi.malhotra@transport.gov", department: "TRANSPORT" },
      { name: "Neha Kapoor", email: "neha.kapoor@transport.gov", department: "TRANSPORT" },
      { name: "Inspector Arjun Thakur", email: "arjun.thakur@police.gov", department: "POLICE" },
      { name: "Sub-Inspector Pooja Nair", email: "pooja.nair@police.gov", department: "POLICE" },
    ];
