...
const AnalysisInsightsPanel = ({ grievance, onClose }) => {
  ...
  const fetchAIInsights = async () => {
    try {
      ...
      // Try to fetch smart recommendations
      try {
      ...
      // Try to fetch resolution time prediction
      try {
        ...
        if (predictionResponse.ok) {
          ...
          if (predictionData.success && predictionData.data?.prediction) {
            setPrediction(predictionData.data.prediction)
          }
        }
      } catch (error) {
        console.log("Prediction not available:", error)
      }
            ...
            <div className="space-y-6">
              {recommendations ? (
                <>
                  ...
                  {/* Similar Cases */}
                  {recommendations.similarCases && recommendations.similarCases.length > 0 && (
                    <div className="bg-slate-700/30 border border-slate-600/30 rounded-lg p-4">
                      <div className="flex items-center gap-3 mb-3">
                  ...
                  {/* Success Factors */}
                  {recommendations.successFactors && recommendations.successFactors.length > 0 && (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-white font-medium mb-2">No Recommendations Available</h3>
                  <p className="text-slate-400 text-sm">
                    AI recommendations will appear when sufficient data is available for analysis.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-6">
              {prediction ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-white font-medium mb-2">No Time Prediction Available</h3>
                  <p className="text-slate-400 text-sm">
                    Time predictions will appear when historical data is available for similar cases.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-6">
              {grievance.analysisData ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-white font-medium mb-2">No Analysis Data Available</h3>
                  <p className="text-slate-400 text-sm">
                    AI analysis data will appear when the grievance is processed by the analysis engine.
                  </p>
                </div>
              )}
            </div>
